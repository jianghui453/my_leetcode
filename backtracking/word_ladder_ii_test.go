...
func TestFindLadder(t *testing.T) {
	...
	h = [][]string{{"cat", "fat", "fit", "fin"}, {"cat", "fat", "fan", "fin"}, {"cat", "can", "fan", "fin"}}
	r = findLadders(beginWord, endWord, wordList)
	t.Logf("beginWord=%s endWord=%s wordList=%v \nh=%v \nr=%v", beginWord, endWord, wordList, h, r)
	...
	h = [][]string{{"sail", "mail", "main", "rain", "ruin", "ruip"}, {"sail", "pail", "pain", "rain", "ruin", "ruip"}}
	r = findLadders(beginWord, endWord, wordList)
	t.Logf("beginWord=%s endWord=%s wordList=%v \nh=%v \nr=%v", beginWord, endWord, wordList, h, r)
}
